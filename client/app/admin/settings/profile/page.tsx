    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div>
        ...
        <p className="mt-2 text-slate-600">
          Xem thông tin đăng nhập và cập nhật họ tên hiển thị của bạn trong hệ thống quản trị.
        </p>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription className="mt-1">
                Quản lý các thông tin cá nhân và định danh quản trị viên của bạn.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSave} className="space-y-5 max-w-lg">
            ...
            <div className="rounded-xl bg-amber-50/70 border border-amber-200 p-4 text-xs text-amber-800 leading-relaxed shadow-sm">
              💡 <strong>Lưu ý bảo mật:</strong> Các thông tin đăng nhập như Tên đăng nhập, Email và Số điện thoại được liên kết chặt chẽ với cơ sở dữ liệu xác thực hệ thống. Vui lòng liên hệ với bộ phận kỹ thuật nếu bạn cần cập nhật các thông tin này.
            </div>
